...
Der knn-Algorhytmus ist einer der bekanntesten und wird daher im folgenden Beispiel dargestellt.
\lstinputlisting[language=Python]{chapters/advancedTopics/src/machinelearning/knnsample.py}\label{knnsample:lst:knnsample}