...
Imports
\lstinputlisting[language=Python,firstline=1,lastline=3]{chapters/advancedTopics/src/machinelearning/knnsample.py}\label{knnsample:lst:knnsample1}

Variablen
\lstinputlisting[language=Python,firstline=5,lastline=13]{chapters/advancedTopics/src/machinelearning/knnsample.py}\label{knnsample:lst:knnsample5}

Methode zur Klassifizierung
\lstinputlisting[language=Python,firstline=15,lastline=52]{chapters/advancedTopics/src/machinelearning/knnsample.py}\label{knnsample:lst:knnsample15}

Daten laden und Anzahl der Zeilen bestimmen
\lstinputlisting[language=Python,firstline=55,lastline=59]{chapters/advancedTopics/src/machinelearning/knnsample.py}\label{knnsample:lst:knnsample55}

Aufruf des Klassifikators
\lstinputlisting[language=Python,firstline=61,lastline=76]{chapters/advancedTopics/src/machinelearning/knnsample.py}\label{knnsample:lst:knnsample61}

Fehler ausgeben
\lstinputlisting[language=Python,firstline=74,lastline=75]{chapters/advancedTopics/src/machinelearning/knnsample.py}\label{knnsample:lst:knnsample74}
...
\lstinputlisting[language=Python,firstline=1,lastline=3]{chapters/advancedTopics/src/machinelearning/bayessample.py}\label{knnsample:lst:bayessample1}

Festlegen von Beispieldaten:
\lstinputlisting[language=Python,firstline=5,lastline=9]{chapters/advancedTopics/src/machinelearning/bayessample.py}\label{knnsample:lst:bayessample5}

Modell erzeugen, mit den Daten trainieren, Daten vorhersagen, Ergebnisse anzeigen
\lstinputlisting[language=Python,firstline=11,lastline=20]{chapters/advancedTopics/src/machinelearning/bayessample.py}\label{knnsample:lst:bayessample11}