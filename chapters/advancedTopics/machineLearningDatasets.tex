...
Die Ausgabe für \lstinline$target_names$ ist folgende:
\begin{lstlisting}
[0 0 1]
...
Eine\randnotiz{iris-Dataset aus URL laden} weitere Möglichkeit ist das Laden von Daten aus einer URL. Hier wird als Beispiel wieder das Paket \lstinline$iris$ genommen.
