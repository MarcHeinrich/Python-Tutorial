...
Der \emph{file}-Parameter bestimmt den Datenstrom (\emph{Stream}) für den Output. In \emph{sys.stdout} steht für die Konsole. 
...
\kontrollfrage{
	\item[\kontroll] Was sind die Parameter der \emph{print()}-Funktion?
	\item[\kontroll] Welche Funktionalität bietet uns die \emph{print()}-Funktion?
