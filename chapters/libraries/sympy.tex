\section{SymPy}
\label{sympy}
SymPy ist eine Python-Bibliothek für wissenschaftliches Rechnen.
Sie beinhaltet laut der Dokumentation unter anderem Folgendes \cite{numpy}:

\begin{itemize}
  \item Vorwort was ist sympy, für was wird es verwendet
  \item Gotchas: Symbole, Gleichzeichen, exponent, division
  \item Einfache Operationen
  \item Printing
  \item Vereinfachen
  \item Berechnungen
  \item Gleichungen lösen
  \item Matrizen
  \item Fortgeschrittene Ausdrücke
\end{itemize}
